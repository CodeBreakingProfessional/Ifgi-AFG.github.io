...
legend.onAdd = function (map) {
    ...
    div.innerHTML = "<div style='display:inline; background-color: white;'><img src='images/Unterwegs_ChatBot.jpg' style=' width: 20%'><br> Die angezeigten Daten wurden mit Hilfe von E-Scootern und Senseboxen gesammelt.<br>Niedrig <img style='width: 10%; height: 5%;'src='images/legendColor.png'> Hoch</div>";
    return div;
};
legend.addTo(map);
